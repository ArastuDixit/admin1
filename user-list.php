...
?>
	...
	<td>
		<form action="add.php"> 
 		...
 		<button type="submit" title="add" data-toogle="toolpit"><i class="fa fa-plus"></i></button>
	    </form>
		<form action="edit.php">
			<input type="hidden" name='id' id='id' value='<?php echo $row["id"]; ?>'> 
		<button type="submit" title="Edit" data-toogle="toolpit"><i class="fa fa-pencil"></i></button>
	    </form>
		<form action="delete.php">
			<input type="hidden" name='id' id='id' value='<?php echo $row["id"]; ?>'>
		<button type="submit" title="Delete" data-toogle="toolpit"><i class="fa fa-trash-o"></i></button>
	    </form>
    </td>	
    </tr>
<?php
...
for($i=1;$i<=$total_pages;$i++){
	echo "<a href='user-list.php?page=".$i."'>".$i."</a>";
